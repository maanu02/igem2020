...
# EX: (COMMENT OUT LATER)
#wt_wd = "/Users/aneesabhakta/Documents/*iGEM/T7-WT-RNAse"
#mt_name = "3.5 Mutant"
#mt_wd = "/Users/aneesabhakta/Documents/*iGEM/T7-mutant-3.5"
#**********************************************************************
...
mutantcompare_genomes_boxplot <- ggplot(na.omit(cts.to.graph), aes(x= species, y = protein), legend(x = 250, y = 200, legend = c("Wildtype", mt_name), fill = c("red", "blue")), labs(title = "Significance Test performed at alpha = 0.05")) + 
  ...
  scale_color_identity(name = "Legend (alpha = 0.05, n = 96)",
                       breaks = c("blue", "red", "black"),
                       labels = c("Wildtype", mt_name, "Insignificant Difference"),
                       guide = "legend") 
